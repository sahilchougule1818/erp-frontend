...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    children: [
      ...
      { id: 'media-preparation', label: 'Media Preparation', page: 'media-preparation', breadcrumbs: ['Indoor', 'Media Preparation'], module: 'indoor' },
      { id: 'indoor-batch-master', label: 'Batch Master', page: 'indoor-batch-master', breadcrumbs: ['Indoor', 'Batch Master'], module: 'indoor' },
      { id: 'subculturing', label: 'Subculturing', page: 'subculturing', breadcrumbs: ['Indoor', 'Subculturing'], module: 'indoor' },
      ...
      { id: 'indoor-contamination', label: 'Indoor Contamination', page: 'indoor-contamination', breadcrumbs: ['Indoor', 'Indoor Contamination'], module: 'indoor' },
